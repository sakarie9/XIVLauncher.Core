...
{
    public string Label { get; } = "Dxvk-Nvapi 0.9.2";
    public string Description { get; } = "For DLSS with nVidia cards and Stable Dxvk release. Does nothing with non-DLSS cards.";
    public string Name { get; } = "dxvk-nvapi-v0.9.2";
    public string DownloadUrl { get; } = "https://github.com/jp7677/dxvk-nvapi/releases/download/v0.9.2/dxvk-nvapi-v0.9.2.tar.gz";
